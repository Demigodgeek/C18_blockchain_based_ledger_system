...
# Code additional input areas for the user interface of your Streamlit application. 
# Create these input areas to capture the sender, receiver, and amount 
# for each transaction that you’ll store in the `Block` record.
